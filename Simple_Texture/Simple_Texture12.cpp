...
namespace EnablingTests
{
    namespace D3D12
    {
		void Simple_Texture::RegisterCases(TestGroup* group)
        {
            ...
            // [AR-BEFORE-COMMIT] Add cases:
            // Manual cases (for correlated parameters)
            ...
            parameters(parameters)			
        {
			...
			SetOptimizedClearValueForRenderTargets(float4(0.5f, 0.4f, 1.0f, 1.0f)); 
        }
        ...
        void Simple_Texture::SetupUploadHeaps()
        {
			...
			if (DirectX::LoadFromWICFile(L"C:\\Users\\dshirke\\Source\\Repos\\ET_1\\EnablingTests-master\\Tests\\D3D11\\Benchmarks\\BenchSobel\\BenchSobel.bmp", DirectX::WIC_FLAGS_FORCE_RGB, nullptr, image) != S_OK)
			...
			Device->CreateShaderResourceView(
				ShaderResourceView().SetResource(shaderResource),
